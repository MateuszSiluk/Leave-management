...
namespace Leave_management.Controllers
{
    ...
    public class LeaveRequestController : Controller
    {
        ...
        public async Task<ActionResult> MyLeave()
        {
            ...
            var employeeAlloctions = await  _leaveAllocRepo.GetLeaveAllocationByEmployee(employeeid);
            var employeeRequests = await _leaveRequestRepo.GetLeaveRequestsByEmployee(employeeid);

            var emplyeeAllocationsModel = _mapper.Map<List<LeaveAllocationVM>>(employeeAlloctions);
            var employeeRequestsModel = _mapper.Map<List<LeaveRequestVM>>(employeeRequests);

            var model = new EmployeeLeaveRequestViewVM
            {
                LeaveAllocations = emplyeeAllocationsModel,
        ...
        public async Task<ActionResult> ApproveRequest(int id)
        {
            try
            {
                ...
                var leaveRequest = await _leaveRequestRepo.FindByID(id);
                var emplyeeid = leaveRequest.RequestingEmployeeId;
                var leaveTypeId = leaveRequest.LeaveTypeId;
                var allocation = await _leaveAllocRepo.GetLeaveAllocationByEmployeeAndType(emplyeeid, leaveTypeId);
        ...
        public async Task<ActionResult> Create(CreateLeaveRequestVM model)
        {
            ...
            try
            {
                ...
                {
                    ModelState.AddModelError("", "You Do Not have Sufficient days for tho request");
                    return View(model);
                }

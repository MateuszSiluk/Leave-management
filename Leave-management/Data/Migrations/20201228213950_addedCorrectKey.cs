...
{
    public partial class addedCorrectKey : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RequestiongEmployeeId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequestVM_EmployeeVM_RequestiongEmployeeId",
                        column: x => x.RequestiongEmployeeId,
                        principalTable: "EmployeeVM",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequestVM_RequestiongEmployeeId",
                table: "LeaveRequestVM",
                column: "RequestiongEmployeeId");
        }
